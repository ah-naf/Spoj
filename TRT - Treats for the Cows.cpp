...
int n;vii v;
ll dp[2005][2005];
ll func(int pos1, int pos2, int a) {
    if(a > n || pos1 >= n || pos2 < 0) return 0;
    if(dp[pos1][pos2] != -1) return dp[pos1][pos2];
    ll val1 = (v[pos1]*a) + func(pos1+1, pos2, a+1);
    ll val2 = (v[pos2]*a) + func(pos1, pos2-1, a+1);
    return dp[pos1][pos2] = max(val1, val2);
}
int main()
{
    AHNAF;
